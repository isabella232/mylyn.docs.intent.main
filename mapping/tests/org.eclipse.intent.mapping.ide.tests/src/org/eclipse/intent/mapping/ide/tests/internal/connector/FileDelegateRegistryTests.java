 ...
 *    ...
 *******************************************************************************/
package org.eclipse.intent.mapping.ide.tests.internal.connector;
...
public class FileDelegateRegistryTests {
	 ...
	 */
	public static final String CONTENT_TYPE_A = "org.eclipse.intent.mapping.ide.tests.content-typeA";

	/**
	 * Content type B {@link IContentType#getId() ID}.
	 */
	public static final String CONTENT_TYPE_B = "org.eclipse.intent.mapping.ide.tests.content-typeB";

	/**
	 * Content type C {@link IContentType#getId() ID}.
	 */
	public static final String CONTENT_TYPE_C = "org.eclipse.intent.mapping.ide.tests.content-typeC";
