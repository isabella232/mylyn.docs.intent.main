...
public class RetroSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case RetroPackage.DEVELOPPER_FEATURE: {
				...
				if (result == null)
					result = caseFeature(developperFeature);
				if (result == null)
					result = defaultCase(theEObject);
				return result;
			}
			case RetroPackage.END_USER_FEATURE: {
				...
				if (result == null)
					result = caseFeature(endUserFeature);
				if (result == null)
					result = defaultCase(theEObject);
				return result;
			}
			...
			case RetroPackage.API: {
				...
				if (result == null)
					result = caseDevelopperFeature(api);
				if (result == null)
					result = caseFeature(api);
				if (result == null)
					result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Bundle</em>'. <!-- begin-user-doc
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>API</em>'. <!-- begin-user-doc -->
	 * This implementation returns null; returning a non-null result will terminate the switch. <!--
	 * end-user-doc -->
	 * 
	 * @param object
