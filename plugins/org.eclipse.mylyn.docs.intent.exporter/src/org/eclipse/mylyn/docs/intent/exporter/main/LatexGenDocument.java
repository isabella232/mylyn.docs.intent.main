...
public class LatexGenDocument extends AbstractAcceleoGenerator {
	 ...
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "/org/eclipse/mylyn/docs/intent/exporter/main/LatexGenDocument";
	 ...
	 * @generated
	 */
	public static final String[] TEMPLATE_NAMES = { "LatexDocumentGen", "LatexGenDocumentDocument" };
	 ...
	 *             saved to disk.
	 */
	public void doGenerate(Monitor monitor, String projectName,
			RepositoryAdapter repositoryAdapter) throws IOException {
		this.projectName = projectName;
		IntentAcceleoServices.initialize(projectName, getTargetFolder(), false,
				repositoryAdapter);
