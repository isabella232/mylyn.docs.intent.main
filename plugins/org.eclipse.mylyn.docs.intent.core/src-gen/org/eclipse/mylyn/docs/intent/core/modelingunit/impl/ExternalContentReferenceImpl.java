...
public class ExternalContentReferenceImpl extends ResourceDeclarationImpl implements ExternalContentReference {
	...
	public ExternalContent getExternalContent() {
		return (ExternalContent)eGet(
				ModelingUnitPackage.Literals.EXTERNAL_CONTENT_REFERENCE__EXTERNAL_CONTENT, true);
	}
	 ...
	 * @generated
	 */
	public void setExternalContent(ExternalContent newExternalContent) {
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.mylyn.docs.intent.core.modelingunit.impl.ResourceDeclarationImpl#getUri()
	 * @generated NOT
	 */
	@Override
	public Object getUri() {
		return "externalFile:/" + super.getUri();
	}
