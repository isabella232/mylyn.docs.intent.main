...
public class IntentCompareConfiguration extends CompareConfiguration {
	 ...
	 *            the left element (generated by Intent)
	 * @param workingCopyResource
	 *            the right element (used by user in working copy)
	 */
	public IntentCompareConfiguration(EObject left, EObject right) {
		this.workingCopyElement = right;
	}
