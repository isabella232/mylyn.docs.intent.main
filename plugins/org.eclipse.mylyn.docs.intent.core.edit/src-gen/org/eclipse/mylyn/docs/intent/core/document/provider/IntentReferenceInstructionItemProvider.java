...
/**
 * This is the item provider adapter for a {@link org.eclipse.mylyn.docs.intent.core.document.IntentReferenceInstruction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IntentReferenceInstructionItemProvider extends UnitInstructionItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
	/**
	 ...
	 * @generated
	 */
	public IntentReferenceInstructionItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addTextToPrintPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				getResourceLocator(),
				getString("_UI_IntentReferenceInstruction_textToPrint_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_IntentReferenceInstruction_textToPrint_feature",
						"_UI_IntentReferenceInstruction_type"),
				IntentDocumentPackage.Literals.INTENT_REFERENCE_INSTRUCTION__TEXT_TO_PRINT, true, false,
				false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}

	/**
	 * This returns IntentReferenceInstruction.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/IntentReferenceInstruction"));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(IntentReferenceInstruction.class)) {
			case IntentDocumentPackage.INTENT_REFERENCE_INSTRUCTION__INTENT_HREF:
			case IntentDocumentPackage.INTENT_REFERENCE_INSTRUCTION__TEXT_TO_PRINT:
