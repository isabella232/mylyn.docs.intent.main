...
/**
 * This is the item provider adapter for a {@link org.eclipse.mylyn.docs.intent.core.document.IntentReference} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IntentReferenceItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
	/**
	 ...
	 * @generated
	 */
	public IntentReferenceItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((IntentReference)object).getIntentHref();
		return label == null || label.length() == 0 ? getString("_UI_IntentReference_type")
				: getString("_UI_IntentReference_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(IntentReference.class)) {
