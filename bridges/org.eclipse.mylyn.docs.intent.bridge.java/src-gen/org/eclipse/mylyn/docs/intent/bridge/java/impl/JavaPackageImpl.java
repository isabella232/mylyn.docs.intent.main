...
public class JavaPackageImpl extends EPackageImpl implements JavaPackage {
	 ...
	 * @generated
	 */
	private EClass abstractCapableElementEClass = null;
	 ...
	 * @see org.eclipse.mylyn.docs.intent.bridge.java.JavaPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public EAttribute getVisibleElement_Visibility() {
		return (EAttribute)visibleElementEClass.getEStructuralFeatures().get(0);
	}
	...
	public EAttribute getVisibleElement_Static() {
		return (EAttribute)visibleElementEClass.getEStructuralFeatures().get(1);
	}
	...
	public EAttribute getVisibleElement_Final() {
		return (EAttribute)visibleElementEClass.getEStructuralFeatures().get(2);
	}
	...
	public EAttribute getAbstractCapableElement_Abstract() {
		return (EAttribute)abstractCapableElementEClass.getEStructuralFeatures().get(0);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(javadocEClass, JAVADOC__CONTENT);

		documentedElementEClass = createEClass(DOCUMENTED_ELEMENT);
		createEReference(documentedElementEClass, DOCUMENTED_ELEMENT__JAVADOC);
	...
	public void initializePackageContents() {
		...
		namedElementEClass.getESuperTypes().add(this.getDocumentedElement());
		visibleElementEClass.getESuperTypes().add(this.getNamedElement());
		abstractCapableElementEClass.getESuperTypes().add(this.getVisibleElement());
		fieldEClass.getESuperTypes().add(this.getVisibleElement());
		classifierEClass.getESuperTypes().add(this.getAbstractCapableElement());
		methodEClass.getESuperTypes().add(this.getAbstractCapableElement());
		...
		initEAttribute(getJavadoc_Content(), ecorePackage.getEString(), "content", null, 0, 1, Javadoc.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getDocumentedElement_Javadoc(), this.getJavadoc(), null, "javadoc", null, 0, 1, DocumentedElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getClassifier_Extends(), ecorePackage.getEString(), "extends", null, 0, 1, Classifier.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getClassifier_Implements(), ecorePackage.getEString(), "implements", null, 0, -1, Classifier.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		getClassifier_Fields().getEKeys().add(this.getNamedElement_Name());
		...
		getClassifier_Methods().getEKeys().add(this.getNamedElement_Name());

		initEClass(methodEClass, Method.class, "Method", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getMethod_SimpleName(), ecorePackage.getEString(), "simpleName", null, 1, 1, Method.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getMethod_Exceptions(), ecorePackage.getEString(), "exceptions", null, 0, -1, Method.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEEnumLiteral(classifierKindEEnum, ClassifierKind.ENUM);
