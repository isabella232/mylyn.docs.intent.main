...
public class MethodItemProvider
	extends AbstractCapableElementItemProvider
	implements
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Method_simpleName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Method_simpleName_feature", "_UI_Method_type"),
	...
	protected void addContentPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Method_content_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Method_content_feature", "_UI_Method_type"),
				 JavaPackage.Literals.METHOD__CONTENT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addExceptionsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Method_exceptions_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Method_exceptions_feature", "_UI_Method_type"),
				 JavaPackage.Literals.METHOD__EXCEPTIONS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(JavaPackage.Literals.METHOD__PARAMETERS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(JavaPackage.Literals.METHOD__PARAMETERS,
				 JavaFactory.eINSTANCE.createParameter()));
	}
